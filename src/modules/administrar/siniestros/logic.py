...
from src.modules.administrar.siniestros.db import TABLA, TABLA_HISTORIAL
...
def _validar_datos(client_id, vehicle_id, insurance_company_id, claim_status_id, branch_id, opened_date):
...
def crear_siniestro(client_id, vehicle_id, claim_status_id, branch_id, opened_date,
                     insurance_company_id=None, description=None,
    ...
    estado anterior)."""
    _validar_datos(client_id, vehicle_id, insurance_company_id, claim_status_id, branch_id, opened_date)

    with obtener_conexion() as conexion:
        cursor = conexion.execute(
            f"""
            INSERT INTO {TABLA}
                (client_id, vehicle_id, insurance_company_id, claim_status_id, branch_id,
...
def actualizar_siniestro(id_siniestro, client_id=None, vehicle_id=None, claim_status_id=None,
    ...
    para desvincularla explícitamente pasar quitar_aseguradora=True.
    ...
    _validar_datos(
        nuevos["client_id"], nuevos["vehicle_id"], nuevos["insurance_company_id"],
    ...
    with obtener_conexion() as conexion:
        conexion.execute(
            f"""
            UPDATE {TABLA}
            SET client_id = ?, vehicle_id = ?, insurance_company_id = ?, claim_status_id = ?,
                branch_id = ?, opened_date = ?, description = ?
            WHERE id = ?
            """,
            (nuevos["client_id"], nuevos["vehicle_id"], nuevos["insurance_company_id"],
             nuevos["claim_status_id"], nuevos["branch_id"], nuevos["opened_date"],
